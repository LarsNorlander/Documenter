        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <h5 class="light-h5">Sharing documents shouldn't mean walking from one office to another. Getting
                    ...
                    storing all your documents for easy retrieval, sharing and safekeeping. Document work should be a
                    little
                    more like this.</h5>
                <br/>
...
@section('footer')
    <div class="footer">
        Developed by Lars, Amie, Dudz, and Emman with wit and class. <span class="glyphicon glyphicon-glass"></span>
    </div>
@stop
