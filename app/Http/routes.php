...
Route::get('/dashboard/deptArchived' , 'DepartmentHeadController@deptArchived');
...
Route::get('/admin/deleted' , 'AdminController@deleted');
Route::get('/admin/delreq/restore/{id}' , 'AdminController@restore');
